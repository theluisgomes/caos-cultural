...
export const AgentCard: React.FC<AgentCardProps> = ({ listing, onClick }) => (
  <div className="group cursor-pointer flex flex-col gap-4" onClick={onClick}>
    <div className="relative aspect-[4/5] overflow-hidden rounded-sm bg-zinc-900">
      ...
      <div className="absolute top-3 left-3 bg-emerald-600 text-white text-[10px] font-bold uppercase tracking-widest px-2 py-1">Agente</div>

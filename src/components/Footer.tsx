        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-sm text-zinc-500">
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li><Link to="/faq" className="hover:text-brand-500 transition-colors">Perguntas Frequentes</Link></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/about" className="hover:text-brand-500 transition-colors">Manifesto</Link></li>
            </ul>
          </div>
          <div className="space-y-4">
            <h5 className="font-bold text-white uppercase tracking-wider text-xs">Criar no CAOS</h5>
            <ul className="space-y-3">
              <li><Link to="/create" className="hover:text-brand-500 transition-colors">Criar um projeto</Link></li>
              <li><Link to="/create" className="hover:text-brand-500 transition-colors">Recursos para artistas</Link></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li><Link to="/about" className="hover:text-brand-500 transition-colors">Sobre nós</Link></li>
